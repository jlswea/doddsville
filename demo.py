...
def main():
    ...
    conn.execute("INSERT INTO security (isin, name) VALUES ('US0378331005', 'Apple Inc.')")
    conn.execute("INSERT INTO security (isin, name) VALUES ('US5949181045', 'Microsoft Corp.')")
    conn.commit()
    conn.close()
